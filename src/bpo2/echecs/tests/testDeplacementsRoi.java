...
public class testDeplacementsRoi {
    ...
    public void testCoupsPossibleRoiCentre(){
        ...
        plateau.ajouterPiece(new Cavalier(CouleurPiece.BLANC, new Case(3, 2)));
        deplacements = plateau.getPiece(new Case(2, 2)).deplacementsPossibles(plateau);
        assertEquals(deplacements.size(), 7);

        plateau.ajouterPiece(new Cavalier(CouleurPiece.NOIRE, new Case(2, 1)));
        deplacements = plateau.getPiece(new Case(2, 2)).deplacementsPossibles(plateau);
        assertEquals(deplacements.size(), 7);
    ...
    public void testCoupsPossibleRoiBordLigne(){
        Plateau plateau = new Plateau();
        plateau.ajouterPiece(new Roi(CouleurPiece.BLANC, new Case(0, 4)));
    ...
    public void testDeplacementRoiCoin(){
        Plateau plateau = new Plateau();
        plateau.ajouterPiece(new Roi(CouleurPiece.BLANC, new Case(0, 7)));
